...
namespace Foam
{
    defineTypeNameAndDebug(NoCorrection, 0);
...
Foam::NoCorrection::NoCorrection
(
...
Foam::tmp<Foam::scalarField> Foam::NoCorrection::Jd
(
...
) const
{
    ...
    scalarField Cds = 24*1.0/Re + 4.0*pow(Re,-0.5) + 0.4;
